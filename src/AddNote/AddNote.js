...
export default class AddNote extends Component {
  ...
  state = {
    ...
    content: "",
    contentValid: false,
    folder_id: this.setFolderId(),
    folderIdValid: this.setFolderId() ? true : false,
    error: null,
    validateMsg: {},
    validForm: false
  };
        ...
        >
          <div className="field">
            <label htmlFor="note-name-input">
              ...
              <ValidationError
                ...
                message={this.state.validateMsg.name}
              />
            </label>
            <input
              type="text"
          ...
          <div className="field">
            <label htmlFor="note-content-input">
              Content
              <ValidationError
                isValid={this.state.contentValid}
                message={this.state.validateMsg.content}
              />
            </label>
            <textarea
          ...
          <div className="field">
            <label htmlFor="note-folder-select">
              Folder
              <ValidationError
                isValid={this.state.folderIdValid}
                message={this.state.validateMsg.folderId}
              />
            </label>
            <select
